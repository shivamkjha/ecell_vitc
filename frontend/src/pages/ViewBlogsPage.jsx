    ...
    <div>
      ...
      <div className=" border-black h-screen">
        <div className="border-2 border-black bg-primary text-white flex w-screen justify-evenly font-semibold p-3">
          ...
          <div className="w-1/6 text-center flex items-center">Author</div>
        ...
        {blogsData.map((blog, index) => (
          <div key={index} className="border-b-2 border-black flex w-screen justify-evenly font-semibold p-3">
            ...
            <div className="w-1/6 flex items-center text-center">
              <p>{blog.dateOfModification }</p>
            </div>
            <div className="w-1/6 text-start flex items-centerr">
              <p>{blog.author}</p>
            </div>
            <div className="w-1/6 text-center flex items-center">
              <Button variant="contained" color="success" onClick={() => handleView(blog)}>
                View
              </Button>
            </div>
            <div className="w-1/6 text-center flex items-center">
              <Button variant="contained" onClick={() => handleEdit(blog)}>
                Edit
              </Button>
            </div>
            <div className="w-1/6 text-center flex items-center">
              <Button variant="contained" color="error" onClick={() => handleDelete(blog)}>
                Delete
              </Button>
            </div>
            <div className="w-1/6 text-center flex items-center">
...
const BlogsTable = ({ blog, index }) => {
  const { dateOfModification , author, likes } = blog;
